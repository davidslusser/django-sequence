    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('result', models.ForeignKey(default=django_sequence.models.get_default_stage_result, help_text='outcome of model_sequence stage', on_delete=django.db.models.deletion.CASCADE, to='django_sequence.stageresult')),
                ...
                ('state', models.ForeignKey(default=django_sequence.models.get_default_stage_state, help_text='current activity of model_sequence stage', on_delete=django.db.models.deletion.CASCADE, to='django_sequence.stagestate')),
            ],
            options={
                'ordering': ['order'],
            },
